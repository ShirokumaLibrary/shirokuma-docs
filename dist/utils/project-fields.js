...
export async function getProjectFields(projectId) {
    const result = await runGraphQL(GRAPHQL_QUERY_FIELDS, { projectId });
    if (!result.success) {
 ...
 */
export async function updateSelectField(projectId, itemId, fieldId, optionId, logger) {
 ...
 * Logs GraphQL errors as warnings if present.
 */
export async function updateTextField(projectId, itemId, fieldId, text, logger) {
 ...
 * Logs GraphQL errors as warnings if present.
 */
export async function updateNumberField(projectId, itemId, fieldId, value, logger) {
 ...
 * Logs GraphQL errors as warnings if present.
 */
export async function updateDateField(projectId, itemId, fieldId, date, logger) {
 ...
 */
export async function addItemToProject(projectId, contentId, logger) {
 ...
 */
function resolveOptionId(fieldName, value, options, logger) {
    // Exact match first
    ...
    const match = Object.entries(options).find(([key]) => key.toLowerCase() === lowerValue);
    if (match) {
 ...
 */
export async function setItemFields(projectId, itemId, fields, logger, cachedFields, currentStatus) {
 ...
 */
export async function autoSetTimestamps(projectId, itemId, statusValue, projectFields, logger, timestamp) {
...
//# sourceMappingURL=project-fields.js.map