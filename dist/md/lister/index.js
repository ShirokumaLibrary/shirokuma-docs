...
export class Lister {
     ...
     */
    format(result, format, sourceDir) {
        switch (format) {
            case 'simple':
    ...
    async collectFiles(sourceDir, options) {
    ...
    async parseFiles(files, sourceDir) {
        const fileInfos = [];
