...
program
    .name('shirokuma-md')
    .description('LLM-optimized Markdown document management system')
    .version('0.1.0');
// Build command
program
    .command('build')
...
program
    .command('extract')
    .description('Extract information from markdown files and create shirokuma-md compatible files')
