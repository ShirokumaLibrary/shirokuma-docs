...
import { categoryLabels, getCdnScripts, getDetailStyles, getDetailScripts, generateTestPageUrl, } from "./details-styles.js";
/**
 * 詳細ページ HTML を生成
 */
export function generateDetailHTML(data, ctx) {
    const typeLabels = {
        screen: "Screen",
        component: "Component",
 ...
 * JSDocセクションのHTMLを生成
 */
export function generateJSDocSection(jsDoc, fallbackDescription) {
    ...
    const metaTags = parsed.tags.filter((t) => ["serverAction", "feature", "dbTables", "module"].includes(t.name));
 ...
 * タグ名を日本語ラベルに変換
 */
export function getTagLabel(tagName) {
    const labels = {
 ...
 * テストセクション HTML を生成
 */
export function generateTestSectionHTML(testCases, analysis, color) {
    ...
    const scoreColor = analysis.coverageScore >= 70 ? "#22c55e" : analysis.coverageScore >= 40 ? "#f59e0b" : "#ef4444";
...
//# sourceMappingURL=details-html.js.map