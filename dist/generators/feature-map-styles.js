 ...
 * デフォルト設定を取得
 */
export function getDefaultFeatureMapConfig() {
    return {
        enabled: true,
        include: [
            "apps/*/app/**/*.tsx",
 ...
 * ファイルを収集
 */
export function collectFiles(projectPath, config) {
 ...
 * スクリプト
 */
export function getScripts(featureMap, config) {
    return `
    // DOM Elements
...
//# sourceMappingURL=feature-map-styles.js.map