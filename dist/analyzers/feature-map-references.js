 ...
 */
export function mergeInferredReferences(allItems, referenceResult, projectPath) {
 ...
 */
export function buildModuleReferences(allItems, referenceResult, projectPath) {
    // パス → アイテムのマップを構築
    const pathToItem = new Map();
    for (const item of allItems) {
        if (item.type === "module") {
