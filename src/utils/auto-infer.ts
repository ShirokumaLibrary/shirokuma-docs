 ...
 * ```
 */
export function inferRouteFromFilePath(filePath: string): string | null {
 ...
 * ```
 */
export function inferComponentsFromImports(content: string): string[] {
 ...
 * ```
 */
export function inferDbTablesFromDrizzleCalls(content: string): string[] {
  const tables: string[] = [];
