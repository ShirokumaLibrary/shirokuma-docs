...
export const TERMINAL_STATUSES: readonly string[] = [STATUS_VALUES.DONE, STATUS_VALUES.RELEASED];
...
export const STATUS_TRANSITIONS: Record<string, readonly string[]> = {
  [STATUS_VALUES.ICEBOX]: [STATUS_VALUES.BACKLOG],
  [STATUS_VALUES.BACKLOG]: [STATUS_VALUES.PLANNING, STATUS_VALUES.SPEC_REVIEW, STATUS_VALUES.IN_PROGRESS, STATUS_VALUES.ICEBOX],
  [STATUS_VALUES.PLANNING]: [STATUS_VALUES.SPEC_REVIEW, STATUS_VALUES.BACKLOG],
  [STATUS_VALUES.SPEC_REVIEW]: [STATUS_VALUES.IN_PROGRESS, STATUS_VALUES.BACKLOG],
  [STATUS_VALUES.IN_PROGRESS]: [
    STATUS_VALUES.REVIEW,
    STATUS_VALUES.TESTING,
    STATUS_VALUES.DONE,
