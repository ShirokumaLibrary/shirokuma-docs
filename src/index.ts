...
program
  ...
  .description(
    "GitHub Issues 管理 with Projects (list, show, create, update, comment, comment-edit, close, reopen, import, fields, remove, search, pr-create, pr-comments, merge, pr-reply, resolve, sub-list, sub-add, sub-remove)"
  )
