 ...
 */
export async function lintAnnotationsCommand(
 ...
 * アノテーションを自動修正
 */
async function runFixAnnotations(
  projectPath: string,
  config: LintAnnotationsConfig,
  logger: ReturnType<typeof createLogger>
): Promise<FixResultSummary[]> {
 ...
 */
async function runLintAnnotations(
  projectPath: string,
  config: LintAnnotationsConfig,
  logger: ReturnType<typeof createLogger>
): Promise<LintAnnotationsReport> {
