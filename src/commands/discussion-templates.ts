...
async function cmdGenerate(
  options: DiscussionTemplatesOptions,
  logger: Logger
): Promise<number> {
 ...
 */
async function cmdListLanguages(
  _options: DiscussionTemplatesOptions,
  logger: Logger
): Promise<number> {
 ...
 */
export async function discussionTemplatesCommand(
  action: string,
