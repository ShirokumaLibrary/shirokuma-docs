 ...
 */
export async function lintCoverageCommand(options: LintCoverageOptions): Promise<void> {
...
export async function runLintCoverage(options: RunLintCoverageOptions): Promise<CoverageReport> {
