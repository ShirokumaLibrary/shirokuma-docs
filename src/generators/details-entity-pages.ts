 ...
 * JSON用に詳細データを収集
 */
export function collectDetailJsonItem(
  ctx: DetailsContext,
  ...
  const byCategory: Record<string, { name: string; file: string; line: number; summary: string; purpose?: string; expected?: string; bdd?: { given?: string; when?: string; then?: string; and?: string[] } }[]> = {};
  ...
  let inputSchema: DetailJsonItem["inputSchema"] | undefined;
  ...
  let outputSchema: DetailJsonItem["outputSchema"] | undefined;
  if (outputSchemaTag) {
  ...
  let errorCodes: DetailJsonItem["errorCodes"] | undefined;
  if (errorCodesTag) {
 ...
 * Screen 詳細ページを生成
 */
export function generateScreenDetailPage(
  screen: Screen,
  detailsDir: string,
  projectPath: string,
  projectName: string,
 ...
 * Component 詳細ページを生成
 */
export function generateComponentDetailPage(
  component: Component,
  detailsDir: string,
  projectPath: string,
  projectName: string,
 ...
 * Action 詳細ページを生成
 */
export function generateActionDetailPage(
  action: Action,
  detailsDir: string,
  projectPath: string,
  projectName: string,
 ...
 * Table 詳細ページを生成
 */
export function generateTableDetailPage(
  table: Table,
  detailsDir: string,
  projectPath: string,
  projectName: string,
 ...
 */
export function generateModuleItemDetailPage(
  mod: Module,
  featureName: string,
  detailsDir: string,
  projectPath: string,
